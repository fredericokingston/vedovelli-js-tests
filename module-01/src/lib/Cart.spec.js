...
describe("Cart", () => {
  ...
  describe("special conditions", () => {
    ...
    it("should NOT apply quantity discount for even quantities whem conditions not met", () => {
      const condition = {
        quantity: 2,
      };
    ...
    it("should receive two or more conditons and determine/aply the best discount. First case", () => {
      const condition1 = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it("should receive two or more conditons and determine/aply the best discount. Second case", () => {
      const condition1 = {
        percentage: 80,
        minimum: 2,
      };
